...
export const VENDOR_TOOL_CONFIG: Record<string, Record<string, ToolConfig>> = {
  autotask: {
    ...
    // --- Phase-1b classifications (verb-heuristic + warden 6-class criterion, 2026-06-18) ---
    autotask_create_contract: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_contract_service: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_expense_item: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_opportunity: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_phase: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_quote_item: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_service_call: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_service_call_ticket: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_service_call_ticket_resource: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_ticket_attachment: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_ticket_charge: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_create_ticket_checklist_item: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_get_company_site_configuration: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_get_invoice_details: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_get_opportunity: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_get_product: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_get_quote_item: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_get_service: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_get_service_bundle: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_get_service_call: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_get_ticket_charge: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_get_ticket_history: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_list_categories: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_list_category_tools: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_list_phases: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_opportunities: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_products: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_quote_items: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_service_bundles: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_service_call_ticket_resources: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_service_call_tickets: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_service_calls: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_services: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_ticket_charges: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_ticket_checklist_items: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_ticket_history: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_search_time_entries: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_test_connection: { entityType: 'generic', ttlMs: 0, isWrite: false },
    autotask_update_company: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_update_contact: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_update_contract: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_update_contract_service: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_update_project: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_update_quote_item: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_update_service_call: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_update_ticket: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_update_ticket_charge: { entityType: 'generic', ttlMs: 0, isWrite: true },
    autotask_update_ticket_checklist_item: { entityType: 'generic', ttlMs: 0, isWrite: true },
  },
  ...
  cipp: {
    ...
    // --- Phase-1b classifications (verb-heuristic + warden 6-class criterion, 2026-06-18) ---
    cipp_create_group: { entityType: 'generic', ttlMs: 0, isWrite: true },
    cipp_get_tenant_details: { entityType: 'generic', ttlMs: 0, isWrite: false, isAdmin: true },  // class v sensitive-read → admin
    cipp_list_alert_queue: { entityType: 'generic', ttlMs: 0, isWrite: false, isAdmin: true },  // class v sensitive-read → admin
    cipp_list_logs: { entityType: 'generic', ttlMs: 0, isWrite: false, isAdmin: true },  // class v sensitive-read → admin
    cipp_list_mailboxes: { entityType: 'generic', ttlMs: 0, isWrite: false },
    cipp_list_scheduled_items: { entityType: 'generic', ttlMs: 0, isWrite: false },
    cipp_list_user_devices: { entityType: 'generic', ttlMs: 0, isWrite: false, isAdmin: true },  // class v sensitive-read → admin
    cipp_list_user_groups: { entityType: 'generic', ttlMs: 0, isWrite: false },
    cipp_revoke_sessions: { entityType: 'generic', ttlMs: 0, isWrite: true, isAdmin: true },  // class iii auth/identity-mutation → admin
    cipp_set_email_forwarding: { entityType: 'generic', ttlMs: 0, isWrite: true, isAdmin: true },  // class iii auth/identity-mutation → admin
    cipp_set_out_of_office: { entityType: 'generic', ttlMs: 0, isWrite: true, isAdmin: true },  // class iii auth/identity-mutation → admin
  },
  ...
  rootly: {
    ...
    // --- Phase-1b classifications (verb-heuristic + warden 6-class criterion, 2026-06-18) ---
    attach_alert: { entityType: 'generic', ttlMs: 0, isWrite: true },  // manual: attaches alert → write (scoped state mutation)
    check_oncall_health_risk: { entityType: 'generic', ttlMs: 0, isWrite: false, isAdmin: true },  // class v sensitive-read → admin
    check_responder_availability: { entityType: 'generic', ttlMs: 0, isWrite: false },  // manual: check_ → read (query, no state)
    collect_incidents: { entityType: 'generic', ttlMs: 0, isWrite: false },  // manual: collect = fetch → read
    create_alert: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_alert_event: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_alert_group: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_alert_route: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_alert_routing_rule: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_alerts_source: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_catalog: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_catalog_entity: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_cause: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_custom_field: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_custom_form: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_dashboard: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_environment: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_escalation_level: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_escalation_level_paths: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_escalation_path: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_escalation_policy: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_form_field: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_form_field_option: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_form_set: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_functionality: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_heartbeat: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_incident: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_incident_action_item: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_incident_custom_field_selection: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_incident_event: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_incident_form_field_selection: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_incident_type: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_live_call_router: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_on_call_role: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_on_call_shadow: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_override_recommendation: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_override_shift: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_playbook: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_pulse: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_retrospective_process: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_schedule: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_schedule_rotation: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_schedule_rotation_active_day: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_schedule_rotation_user: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_service: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_severity: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_status_page: { entityType: 'generic', ttlMs: 0, isWrite: true },  // manual: status_/sub_status mid-name (write-pattern bypass) → write
    create_status_page_template: { entityType: 'generic', ttlMs: 0, isWrite: true },  // manual: status_/sub_status mid-name (write-pattern bypass) → write
    create_sub_status: { entityType: 'generic', ttlMs: 0, isWrite: true },  // manual: status_/sub_status mid-name (write-pattern bypass) → write
    create_team: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_user_email_address: { entityType: 'generic', ttlMs: 0, isWrite: true, isAdmin: true },  // class iii auth/identity-mutation → admin
    create_user_notification_rule: { entityType: 'generic', ttlMs: 0, isWrite: true, isAdmin: true },  // class iii auth/identity-mutation → admin
    create_user_phone_number: { entityType: 'generic', ttlMs: 0, isWrite: true, isAdmin: true },  // class iii auth/identity-mutation → admin
    create_workflow: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_workflow_form_field_condition: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_workflow_group: { entityType: 'generic', ttlMs: 0, isWrite: true },
    create_workflow_run: { entityType: 'generic', ttlMs: 0, isWrite: true, isAdmin: true },  // class i/ii execution-verb → admin
    create_workflow_task: { entityType: 'generic', ttlMs: 0, isWrite: true },
    find_related_incidents: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_alert: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_alert_by_short_id: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_alert_event: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_alert_group: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_alert_route: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_alert_routing_rule: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_alert_urgency: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_alerts_source: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_catalog: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_catalog_entity: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_cause: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_current_user: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_custom_field: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_custom_field_option: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_custom_form: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_dashboard: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_dashboard_panel: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_environment: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_escalation_level: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_escalation_path: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_escalation_policy: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_form_field: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_form_field_option: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_form_field_placement: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_form_field_placement_condition: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_form_set: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_form_set_condition: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_functionality: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_functionality_incidents_chart: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_functionality_uptime_chart: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_heartbeat: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_incident: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_incident_action_items: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_incident_custom_field_selection: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_incident_form_field_selection: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_incident_retrospective_step: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_incident_sub_status: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_incident_type: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_live_call_router: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_more_tools: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_on_call_role: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_on_call_shadow: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_oncall_handoff_summary: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_oncall_schedule_summary: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_oncall_shift_metrics: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_override_shift: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_playbook: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_playbook_task: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_pulse: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_retrospective_process: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_retrospective_process_group: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_retrospective_step: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_schedule: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_schedule_rotation: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_schedule_shifts: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_service: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_service_incidents_chart: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_service_uptime_chart: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_severity: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_shift_incidents: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_status_page: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_status_page_template: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_sub_status: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_team: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_team_incidents_chart: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_user: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_user_email_addresses: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_user_phone_numbers: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_workflow: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_workflow_form_field_condition: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_workflow_group: { entityType: 'generic', ttlMs: 0, isWrite: false },
    get_workflow_task: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_alert_events: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_alert_groups: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_alert_routing_rules: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_all_incident_action_items: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_catalog_entities: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_catalogs: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_causes: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_custom_fields: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_custom_forms: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_dashboards: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_environments: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_escalation_levels: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_escalation_levels_paths: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_escalation_paths: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_form_field_options: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_form_fields: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_form_sets: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_functionalities: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_heartbeats: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_incident_action_items: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_incident_alerts: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_incident_custom_field_selections: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_incident_events: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_incident_form_field_selections: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_incident_roles: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_incident_types: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_incidents: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_live_call_routers: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_on_call_roles: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_on_call_shadows: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_override_shifts: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_playbooks: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_pulses: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_retrospective_processes: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_schedule_rotation_active_days: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_schedule_rotation_users: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_schedule_rotations: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_schedules: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_services: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_severities: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_shifts: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_status_page_templates: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_status_pages: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_sub_statuses: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_teams: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_users: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_workflow_form_field_conditions: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_workflow_groups: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_workflow_runs: { entityType: 'generic', ttlMs: 0, isWrite: false },
    list_workflow_tasks: { entityType: 'generic', ttlMs: 0, isWrite: false },
    patch_alert_route: { entityType: 'generic', ttlMs: 0, isWrite: true },
    search_incidents: { entityType: 'generic', ttlMs: 0, isWrite: false },
    suggest_solutions: { entityType: 'generic', ttlMs: 0, isWrite: false },  // manual: AI suggestion → read (no state change)
    update_alert_event: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_alert_group: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_alert_route: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_alert_routing_rule: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_alert_urgency: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_catalog: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_catalog_entity: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_cause: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_custom_field: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_custom_field_option: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_custom_form: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_dashboard: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_dashboard_panel: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_environment: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_escalation_level: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_escalation_path: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_escalation_policy: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_form_field: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_form_field_option: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_form_field_placement: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_form_field_placement_condition: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_form_set: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_form_set_condition: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_functionality: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_heartbeat: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_incident: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_incident_action_item: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_incident_custom_field_selection: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_incident_form_field_selection: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_incident_retrospective_step: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_incident_sub_status: { entityType: 'generic', ttlMs: 0, isWrite: true },  // manual: status_/sub_status mid-name (write-pattern bypass) → write
    update_incident_type: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_live_call_router: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_on_call_role: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_on_call_shadow: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_override_shift: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_playbook: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_playbook_task: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_pulse: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_retrospective_process: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_retrospective_process_group: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_retrospective_step: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_schedule: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_schedule_rotation: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_service: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_severity: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_status_page: { entityType: 'generic', ttlMs: 0, isWrite: true },  // manual: status_/sub_status mid-name (write-pattern bypass) → write
    update_status_page_template: { entityType: 'generic', ttlMs: 0, isWrite: true },  // manual: status_/sub_status mid-name (write-pattern bypass) → write
    update_sub_status: { entityType: 'generic', ttlMs: 0, isWrite: true },  // manual: status_/sub_status mid-name (write-pattern bypass) → write
    update_team: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_workflow: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_workflow_form_field_condition: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_workflow_group: { entityType: 'generic', ttlMs: 0, isWrite: true },
    update_workflow_task: { entityType: 'generic', ttlMs: 0, isWrite: true },
  },

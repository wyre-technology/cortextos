...
Reseller-level pricing configuration is scoped to the reseller and not visible to sub-customers (migrations `027`/`028_reseller_pricing_config*.sql`).

---
title: Security
description: How Conduit protects vendor credentials, defends against prompt injection, and enforces multi-tenant isolation — including the trust model and what we will not claim.
---

...
export const FAQ_DATA: Record<string, readonly FaqEntry[]> = {
  ...
  "guides/msp-onboarding": [
    ...
    { q: "How do I connect an MCP client once the tenant is built?", a: "Point Claude Desktop or Claude Code at the Conduit server URL (`https://conduit.wyre.ai/v1/mcp`). On first use an OAuth flow opens a browser for authentication; after sign-in and credential connection, the token is cached and refreshed automatically." },
  ],
  "guides/scim": [

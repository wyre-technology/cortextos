...
---
{/* Content ported verbatim from conduit/docs/src/content/docs/reference/api.mdx on Epic 5 Phase C. Starlight slug-FaqSchema (if any) stripped — FAQ prose still renders. */}
